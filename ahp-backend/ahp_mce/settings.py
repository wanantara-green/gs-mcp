...
# Sandi admin tunggal untuk operasi tulis (CRUD) dari panel admin frontend.
# Kosong = operasi tulis admin DINONAKTIFKAN (aman secara default).
ADMIN_PASSWORD = os.environ.get("ADMIN_PASSWORD", "")

# Basis URL frontend kuisioner (TRAINING-02) untuk tautan di topmenu admin.
# Prod default: training-02.wanantara.org. Lokal: di-override via env ke localhost:8033.
FRONTEND_BASE_URL = os.environ.get("FRONTEND_BASE_URL", "https://training-02.wanantara.org")
...
JAZZMIN_SETTINGS = {
    ...
    "topmenu_links": [
        ...
        {"name": "Form Pakar", "url": f"{FRONTEND_BASE_URL}/mce-index.html", "new_window": True},
        {"name": "Hasil Bobot", "url": f"{FRONTEND_BASE_URL}/mce-hasil.html", "new_window": True},
    ],
    "show_sidebar": True,
